...
| `paper` | Peer-review panel (3 reviewers + area chair/editor) with **venue simulation** — review "at Nature, Science, Cell, Nature Communications, CVPR, ECCV, NeurIPS…" with that venue's standards and decisions | ~0.003 |
